...
export const createInitialDemoUser = (): UserProfile => ({
  ...
  northStarVision: "Build a profitable, sovereign software company that provides true financial independence and deep intellectual freedom.",
  transformationPhase: "Perpetual Execution • Horizon II",
...
export const initialDemoGoals: Goal[] = [
  ...
  },
  {
    id: "goal-3",
    userId: "user-demo-1",
    title: "Scale to $10,000/Month Recurring Revenue",
    description: "Iterate product feedback, establish outbound growth channels, and reach product-market fit.",
    why: "Achieve complete career self-sovereignty and location independence.",
    category: "BUILD",
    priority: "critical",
    horizon: "1_year",
    targetDate: new Date(Date.now() + 300 * 86400000).toISOString().split("T")[0],
    progressPercent: 25,
    status: "active",
    milestones: ["Reach 20 paying customers", "Achieve $3k MRR", "Scale outbound pipeline", "$10k MRR inflection point"],
    projectIds: ["proj-1"],
    habitIds: ["habit-1"],
  ...
  },
  {
    id: "goal-4",
    userId: "user-demo-1",
    title: "Peak Biological Conditioning & Sub-20min 5K",
    description: "Follow progressive resistance training 4x/week and build aerobic base capacity.",
    why: "Physical vitality directly multiplies cognitive energy, executive presence, and mental clarity.",
    category: "IMPROVE",
    priority: "high",
    horizon: "6_months",
    targetDate: new Date(Date.now() + 160 * 86400000).toISOString().split("T")[0],
    progressPercent: 55,
    status: "active",
    milestones: ["12% body fat milestone", "Complete first 10K test run", "Sub-20min 5K time trial"],
    projectIds: [],
    habitIds: ["habit-3"],
...
export const initialDemoTimeline: TimelineEvent[] = [
  {
    ...
    type: "first_focus",
    title: "Initiated Multi-Horizon Transformation Journey",
    description: "Completed comprehensive onboarding, aligned North Star vision, and established first tactical horizons.",
    badgeText: "Day 1",
  },
  {
    id: "tl-2",
