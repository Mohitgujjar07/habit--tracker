...
export const DeveloperDashboard: React.FC = () => {
  return (
    <div className="space-y-6 max-w-6xl mx-auto p-4 sm:p-6 animate-in fade-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <Card className="p-4 space-y-1 bg-white border-surface-200/80 shadow-sm">
          <div className="flex items-center justify-between text-surface-400">
            <span className="text-[11px] font-medium text-surface-600">Coding Deep Work</span>
        ...
        <Card className="p-4 space-y-1 bg-white border-surface-200/80 shadow-sm">
          <div className="flex items-center justify-between text-surface-400">
            <span className="text-[11px] font-medium text-surface-600">Deployments</span>
        ...
        <Card className="p-4 space-y-1 bg-white border-surface-200/80 shadow-sm">
          <div className="flex items-center justify-between text-surface-400">
            <span className="text-[11px] font-medium text-surface-600">Problems Solved</span>
            <Bug size={15} className="text-amber-500" />
          </div>
        ...
        <Card className="p-4 space-y-1 bg-white border-surface-200/80 shadow-sm">
          <div className="flex items-center justify-between text-surface-400">
            <span className="text-[11px] font-medium text-surface-600">Pipeline Health</span>
      ...
      <Card className="p-5 space-y-3 bg-white border-surface-200/80 shadow-sm">
